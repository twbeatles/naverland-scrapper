...
* `naverland-scrapper.spec` 점검 결과, v14.2 변경(월세 필터 분리/고급필터 UI/재시도 설정 연동/차단 감지)은 기존 PyInstaller hidden import 구성으로 빌드 가능하여 추가 수정이 필요하지 않습니다.
