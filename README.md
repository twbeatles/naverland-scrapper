...
* **🧪 CI 정책 조정:** 2026-04-11 당시 GitHub Actions는 `compileall + pyright + preflight` 중심으로 유지했으며, 현재 기준도 다시 `compileall + pyright + preflight`입니다.
...
* **🧪 CI 단순화:** GitHub Actions는 이제 `compileall + pyright + preflight`만 실행합니다.
