...
_rebind_inherited_methods(
    ...
    [
    "__init__",
    "_initialize_database_with_recovery",
    "_recover_from_startup_corruption",
    ...
    "_coerce_int",
    "_coerce_price",
    "_normalize_price_metric",
    "_is_all_filter_value",
    "_row_value",
    "_normalize_snapshot_row",
    "_init_tables",
    "_article_history_requires_migration",
    "_article_favorites_requires_migration",
    "_backup_before_schema_migration",
    "_migrate_article_history_asset_scope_schema",
    "_migrate_article_favorites_asset_scope_schema",
    "add_complex",
    "get_all_complexes",
    ...
    "add_crawl_history",
    "get_crawl_history",
    "_append_snapshot_asset_filter",
    "_append_latest_snapshot_filter",
    "_append_snapshot_metric_filter",
    "get_complex_price_history",
    "add_price_snapshot",
    "add_price_snapshots_bulk",
    "_upsert_price_snapshot_row",
    "get_price_snapshot_pyeongs",
    "get_price_snapshots",
    "add_alert_setting",
    "_normalize_listing_asset_type",
    "_asset_scope_where",
