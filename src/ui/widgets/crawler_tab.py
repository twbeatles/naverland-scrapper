...
_rebind_inherited_methods(
    ...
    "_set_result_row",
    "_compact_sort_descriptor",
    "_compact_sort_value",
    "_find_compact_insert_index",
    "_reindex_compact_row_map",
    "_recompute_compact_row_favorite",
    "_compact_updates_should_coalesce",
    "_schedule_compact_refresh",
    "_flush_compact_updates",
    "_schedule_card_view_refresh",
    "_flush_card_view_refresh",
    "_append_rows_compact_batch",
    "_sort_compact_rows",
    "_render_compact_rows",
    "_update_favorite_state_for_key",
    "_append_rows_batch",
